...
function Sidebar() {
  ...
  return (
    <div className="sidebar" style={{ background: 'linear-gradient(180deg, #0b1329 0%, #060b18 100%)' }}>
      {/* Brand Header */}
      <Link to="/" className="sidebar-brand">
        <span className="sidebar-brand-icon" style={{ background: 'linear-gradient(135deg, #06b6d4, #3b82f6)' }}>
          💡
        </span>
        <span className="sidebar-brand-name" style={{ background: 'linear-gradient(135deg, #38bdf8, #818cf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
          IdeaOS
        </span>
      </Link>

      {/* Section 1: Main Menu */}
      <span className="sidebar-section-label" style={{ color: '#06b6d4' }}>Main Menu</span>
      <nav className="sidebar-nav">
        ...
        <Link to="/powerbi" className={isActive('/powerbi')}>
        ...
        <Link to="/comparables" className={isActive('/comparables')}>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>
          <span>66k Startup Comps</span>
        </Link>
        <Link to="/copilot" className={isActive('/copilot')}>
      ...
      <span className="sidebar-section-label" style={{ color: '#38bdf8' }}>Data & Intel</span>
      <nav className="sidebar-nav">
      ...
      <div className="sidebar-footer" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <nav className="sidebar-nav">
          <span className="sidebar-section-label" style={{ color: '#94a3b8', marginTop: '0.5rem' }}>System</span>
